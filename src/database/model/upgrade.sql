...
-- Atoll v0.41.0
/* run `npm start` to start up app and get it to add new tables, then do the steps below to upgrade old tables */
...
alter table sprintbacklogitem alter column "backlogitempartId" type varchar(32) not null;
